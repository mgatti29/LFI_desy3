    ...
    if 1==1:
            ...
            for rot in range(4):
                ...
                for tomo_bin in config['sources_bins']:
                    ...
                    sources_cat[rot][tomo_bin] = {'g1':g1_map,'g2':g2_map,'e1':e1_,'e2':e2_,'e1n':e1n_,'e2n':e2n_,'pix':idx_}
...
output_temp = '/global/cfs/cdirs/des/mgatti/darkgrid/'
...
##
    ...
    #    #comm.Barrier()
    '''
##srun --nodes=1 --tasks-per-node=64  python run_cosmogrid_baryons.py
##srun --nodes=1 --tasks-per-node=4 --cpus-per-task=16 --cpu-bind=cores  python run_cosmogrid_baryons.py
##srun --nodes=4 --tasks-per-node=16 python run_darkgrid.py
